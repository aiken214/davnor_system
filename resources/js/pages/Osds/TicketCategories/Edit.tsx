...
export default function EditTicketCategory({ offices, ticketCategory }: EditTicketCategoryProps) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Ticket Categories', href: '/ticket-categories' },
        { title: 'Edit Ticket Category', href: '#' },
    ];

    const { data, setData, put, errors, processing } = useForm({
        name: ticketCategory.name || '',
        description: ticketCategory.description || '',
        office_id: String(ticketCategory.office_id || ''),
    });

    function handleFormSubmit(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault();
        put(`/ticket-categories/${ticketCategory.id}`);
    }
